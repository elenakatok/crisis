...
//
//   node crisis-holding-live.mjs      (HEADED=1 to watch, KEEP=1 to leave the stack up)
// ═══════════════════════════════════════════════════════════════════════════════
...
const GAME = {
  project:        'crisis-mygames-live',
  seats:          3,                  // online.seatCount — one full group
  needsPrep:      true,               // online routing is reached only after prep
  holding:        'crisis-online-holding',
  reveal:         'crisis-online-reveal',
  revealContinue: 'crisis-reveal-continue',
  landed:         'crisis-room',      // where Continue (and a classroom match) lands
  emuEnv:         {},
  viteEnv:        {},                 // frontend/.env.local supplies the VITE_ config
}
